...
windPowerDf %>%
  head(20) %>%
  kable(format = "html",
        caption = "Dane dotyczące mocy wiatru",
        col.names = c("Data", "Moc [MW]"),
        align = "c") %>%
  kable_styling(
    full_width = FALSE,
  ...
  column_spec(1,
              width = "200px",
              border_right = TRUE,
              extra_css = "text-align: center; white-space: nowrap;") %>%
  column_spec(2,
              width = "120px",
              border_left = TRUE,
              extra_css = "text-align: center; white-space: nowrap;")
...
electricityDf %>%
  ...
  kable(
    format = "html",
    caption = "Dane dotyczące produkcji energii elektrycznej",
    col.names = c(
      "Kraj", "Kod", "Data", "Rok", "Miesiąc", "Nazwa miesiąca",
      "Produkt", "Wartość", "Kolejność", "YTD",
      "YTD poprzedni rok", "Udział [%]"
    ),
    align = "c"
  ) %>%
  kable_styling(
    full_width = TRUE,  # <<< TABELA zajmuje całą szerokość renderowaną
    bootstrap_options = c("striped", "hover", "condensed", "responsive"),
    position = "center"
  ) %>%
  row_spec(
  ...
  column_spec(1,  width = "10%", extra_css = "text-align: center; white-space: nowrap;") %>%
  column_spec(2,  width = "6%",  extra_css = "text-align: center; white-space: nowrap;") %>%
  column_spec(3,  width = "8%",  extra_css = "text-align: center; white-space: nowrap;") %>%
  column_spec(4,  width = "5%",  extra_css = "text-align: center; white-space: nowrap;") %>%
  column_spec(5,  width = "5%",  extra_css = "text-align: center; white-space: nowrap;") %>%
  column_spec(6,  width = "10%", extra_css = "text-align: center; white-space: nowrap;") %>%
  column_spec(7,  width = "12%", extra_css = "text-align: center; white-space: nowrap;") %>%
  column_spec(8,  width = "8%",  extra_css = "text-align: center; white-space: nowrap;") %>%
  column_spec(9,  width = "8%",  extra_css = "text-align: center; white-space: nowrap;") %>%
  column_spec(10, width = "6%",  extra_css = "text-align: center; white-space: nowrap;") %>%
  column_spec(11, width = "10%", extra_css = "text-align: center; white-space: nowrap;") %>%
  column_spec(12, width = "6%",  extra_css = "text-align: center; white-space: nowrap;")
```


# Processed data tables visualisation
...
windPowerMonthly %>%
  ...
  kable(
    format = "html",
    caption = "Średnia miesięczna moc wiatru - po przetworzeniu",
    col.names = c("Data", "Rok", "Miesiąc", "Średnia moc [MW]"),
    align = "c",
    digits = 2
  ) %>%
  kable_styling(
  ...
  column_spec(1, width = "130px", border_right = TRUE,
              extra_css = "text-align: center; white-space: nowrap;") %>%
  column_spec(2, width = "80px", border_left = TRUE, border_right = TRUE,
              extra_css = "text-align: center; white-space: nowrap;") %>%
  column_spec(3, width = "90px", border_left = TRUE, border_right = TRUE,
              extra_css = "text-align: center; white-space: nowrap;") %>%
  column_spec(4, width = "150px", border_left = TRUE,
              extra_css = "text-align: center; white-space: nowrap;")
...
electricityMonthly %>%
  ...
  kable(
    format = "html",
    caption = "Średnia miesięczna produkcja energii elektrycznej - po przetworzeniu",
    col.names = c("Data", "Rok", "Miesiąc", "Średnia [MWh]"),
    align = "c",
    digits = 2
  ) %>%
  kable_styling(
  ...
  column_spec(1, width = "120px", border_right = TRUE,
              extra_css = "text-align: center; white-space: nowrap;") %>%
  column_spec(2, width = "80px", border_left = TRUE, border_right = TRUE,
              extra_css = "text-align: center; white-space: nowrap;") %>%
  column_spec(3, width = "80px", border_left = TRUE, border_right = TRUE,
              extra_css = "text-align: center; white-space: nowrap;") %>%
  column_spec(4, width = "130px", border_left = TRUE,
              extra_css = "text-align: center; white-space: nowrap;")


```

# Raw time series visalisation

```{r}
# Wind power

# Convert time series to matrix
windPowerMatrix <- matrix(
  data = as.numeric(windPowerMonthlyTs),
  ncol = 12,
  byrow = TRUE
)

# Set month names in Polish
colnames(windPowerMatrix) <- c(
  "Styczeń", "Luty", "Marzec", "Kwiecień", "Maj", "Czerwiec",
  "Lipiec", "Sierpień", "Wrzesień", "Październik", "Listopad", "Grudzień"
)

# Set years as row names
rownames(windPowerMatrix) <- as.character(
  floor(time(windPowerMonthlyTs)[seq(1, length(windPowerMonthlyTs), by = 12)])
)

# Convert to tibble with "Rok" column
windPowerTable <- as_tibble(windPowerMatrix, rownames = "Rok")

# Visualize using kableExtra with grid lines
windPowerTable %>%
  kable(
    format = "html",
    caption = "Moc wiatru - wartości miesięczne jako szereg czasowy",
    align = "c",
    digits = 2
  ) %>%
  kable_styling(
  ...
  column_spec(1, width = "80px",
              border_right = TRUE,
              extra_css = "text-align: center; white-space: nowrap;") %>%
  column_spec(2:12, width = "85px",
              border_left = TRUE, border_right = TRUE,
              extra_css = "text-align: center; white-space: nowrap;") %>%
  column_spec(13, width = "85px",
              border_left = TRUE,
              extra_css = "text-align: center; white-space: nowrap;")
...
# Convert time series to matrix
electricityMatrix <- matrix(
  data = as.numeric(electricityMonthlyTs),
  ncol = 12,
  byrow = TRUE
)

# Set month names in Polish
colnames(electricityMatrix) <- c(
  "Styczeń", "Luty", "Marzec", "Kwiecień", "Maj", "Czerwiec",
  "Lipiec", "Sierpień", "Wrzesień", "Październik", "Listopad", "Grudzień"
)

# Set years as row names
rownames(electricityMatrix) <- as.character(
  floor(time(electricityMonthlyTs)[seq(1, length(electricityMonthlyTs), by = 12)])
)

# Convert to tibble with "Rok" column
electricityTable <- as_tibble(electricityMatrix, rownames = "Rok")

# Visualize using kableExtra with grid lines
electricityTable %>%
  kable(
    format = "html",
    caption = "Produkcja energii elektrycznej – wartości miesięczne jako szereg czasowy",
    align = "c",
    digits = 2
  ) %>%
  kable_styling(
...
```{r}
# Wind power
# Vector of data recording times

# Extract and reshape the time values
windPowerTimeMatrix <- matrix(
  data = time(windPowerMonthlyTs),
  ncol = 12,
  byrow = TRUE
)

# Assign Polish month names
colnames(windPowerTimeMatrix) <- c(
  "Styczeń", "Luty", "Marzec", "Kwiecień", "Maj", "Czerwiec",
  "Lipiec", "Sierpień", "Wrzesień", "Październik", "Listopad", "Grudzień"
)

# Assign years as row names
rownames(windPowerTimeMatrix) <- as.character(
  floor(time(windPowerMonthlyTs)[seq(1, length(windPowerMonthlyTs), by = 12)])
)

# Convert to tibble with "Rok" column
windPowerTimeTable <- as_tibble(windPowerTimeMatrix, rownames = "Rok")

# Format with kableExtra
windPowerTimeTable %>%
  kable(
    format = "html",
    caption = "Wartości time() dla szeregu czasowego – moc wiatru",
    align = "c",
    digits = 3
  ) %>%
  kable_styling(
...
# Observation position in the cycle

# Extract and reshape the cycle values
windPowerCycleMatrix <- matrix(
  data = cycle(windPowerMonthlyTs),
  ncol = 12,
  byrow = TRUE
)

# Assign Polish month names
colnames(windPowerCycleMatrix) <- c(
  "Styczeń", "Luty", "Marzec", "Kwiecień", "Maj", "Czerwiec",
  "Lipiec", "Sierpień", "Wrzesień", "Październik", "Listopad", "Grudzień"
)

# Assign years as row names
rownames(windPowerCycleMatrix) <- as.character(
  floor(time(windPowerMonthlyTs)[seq(1, length(windPowerMonthlyTs), by = 12)])
)

# Convert to tibble with "Rok" column
windPowerCycleTable <- as_tibble(windPowerCycleMatrix, rownames = "Rok")

# Format with kableExtra
windPowerCycleTable %>%
  kable(
    format = "html",
    caption = "Wartości cycle() dla szeregu czasowego – moc wiatru",
    align = "c"
  ) %>%
  kable_styling(
    full_width = FALSE,
...
windPowerTsNumberStats %>%
  kable(
    format = "html",
    caption = "Statystyki szeregu czasowego – moc wiatru",
    align = "c",
    digits = 3
  ) %>%
  kable_styling(
...
# reshape time() output into matrix
electricityTimeMatrix <- matrix(
  data = time(electricityMonthlyTs),
  ncol = 12,
  byrow = TRUE
)

# assign Polish month names as column names
colnames(electricityTimeMatrix) <- c(
  "Styczeń", "Luty", "Marzec", "Kwiecień", "Maj", "Czerwiec",
  "Lipiec", "Sierpień", "Wrzesień", "Październik", "Listopad", "Grudzień"
)

# assign years as row names
rownames(electricityTimeMatrix) <- as.character(
  floor(time(electricityMonthlyTs)[seq(1, length(electricityMonthlyTs), by = 12)])
)

# convert to tibble with "Rok" column
electricityTimeTable <- as_tibble(electricityTimeMatrix, rownames = "Rok")

# render with kableExtra
electricityTimeTable %>%
  kable(
    format = "html",
    caption = "Wartości time() dla szeregu czasowego - produkcja energii",
    align = "c",
    digits = 3
  ) %>%
  kable_styling(
...
# reshape cycle() output into matrix
electricityCycleMatrix <- matrix(
  data = cycle(electricityMonthlyTs),
  ncol = 12,
  byrow = TRUE
)

# assign Polish month names as column names
colnames(electricityCycleMatrix) <- c(
  "Styczeń", "Luty", "Marzec", "Kwiecień", "Maj", "Czerwiec",
  "Lipiec", "Sierpień", "Wrzesień", "Październik", "Listopad", "Grudzień"
)

# assign years as row names
rownames(electricityCycleMatrix) <- as.character(
  floor(time(electricityMonthlyTs)[seq(1, length(electricityMonthlyTs), by = 12)])
)

# convert to tibble with "Rok" column
electricityCycleTable <- as_tibble(electricityCycleMatrix, rownames = "Rok")

# render with kableExtra
electricityCycleTable %>%
  kable(
    format = "html",
    caption = "Wartości cycle() dla szeregu czasowego – produkcja energii",
    align = "c"
  ) %>%
  kable_styling(
    full_width = FALSE,
...
electricityTsNumberStats %>%
  kable(
    format = "html",
    caption = "Statystyki szeregu czasowego – produkcja energii",
    align = "c",
    digits = 3
  ) %>%
  kable_styling(
